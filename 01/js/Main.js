...
Dog.Main = (function() {
	...
	function addHeroObject() {
		...
		var geometry = new THREE.BoxGeometry(300, 60, 300, 1, 1, 60);
		...
		for (var i = 0; i < hero.geometry.vertices.length; i++) {
			...
			if (vert.y > 0) {
				// vert.y += Dog.Utils.randomRange(-2, 2);
		...
		// console.log('Main.js', 'topVertIndexes', topVertIndexes);
