...
Dog.Main = (function() {
	...
	function animateElements() {
		for (var i = 0; i < elements.length; i++) {
			...
			element.position.y = element.positionClone.y + ((Math.sin(Dog.Utils.degToRad(( element.positionClone.x) + animOffset))) * (maxUndulation / 2)) + ((Math.sin(Dog.Utils.degToRad(( element.positionClone.z) + animOffset))) * (maxUndulation / 2));
		}
