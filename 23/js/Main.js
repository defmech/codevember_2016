...
Dog.Main = (function() {
	...
	function animateElements() {
		for (var i = 0; i < elements.length; i++) {
			...
			elementAngle = (elementAngle + speed) % (Math.PI * 4);
			...
			var newScale = element.scaleClone.x * Dog.Utils.map(Math.sin(distanceRoundCirc), -1, 1, 0.4, 1.6);
