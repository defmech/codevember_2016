...
Dog.Main = (function() {
	...
	function animateElements() {
		for (var i = 0; i < slices.length; i++) {
			...
			var distanceRoundCirc = Dog.Utils.map(elementCirc, 0, maxCirc, 0, (Math.PI * 6));
			...
			// slice.rotation.z = Dog.Utils.map(Math.sin(distanceRoundCirc), -1, 1, -(Math.PI / 10), (Math.PI / 10));
			// 
